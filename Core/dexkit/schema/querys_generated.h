...
#ifndef FLATBUFFERS_GENERATED_QUERYS_SCHEMA_H_
#define FLATBUFFERS_GENERATED_QUERYS_SCHEMA_H_
...
struct FindClass FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<int32_t> *in_classes() const {
    return GetPointer<const ::flatbuffers::Vector<int32_t> *>(VT_IN_CLASSES);
  }
  const schema::ClassMatcher *matcher() const {
    return GetPointer<const schema::ClassMatcher *>(VT_MATCHER);
  }
...
struct FindClassBuilder {
  ...
  void add_in_classes(::flatbuffers::Offset<::flatbuffers::Vector<int32_t>> in_classes) {
    fbb_.AddOffset(FindClass::VT_IN_CLASSES, in_classes);
  }
  void add_matcher(::flatbuffers::Offset<schema::ClassMatcher> matcher) {
...
inline ::flatbuffers::Offset<FindClass> CreateFindClass(
    ...
    ::flatbuffers::Offset<::flatbuffers::Vector<int32_t>> in_classes = 0,
    ::flatbuffers::Offset<schema::ClassMatcher> matcher = 0) {
...
inline ::flatbuffers::Offset<FindClass> CreateFindClassDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    bool unique_result = false,
    const std::vector<int32_t> *in_classes = nullptr,
    ::flatbuffers::Offset<schema::ClassMatcher> matcher = 0) {
  auto in_classes__ = in_classes ? _fbb.CreateVector<int32_t>(*in_classes) : 0;
  return schema::CreateFindClass(
      _fbb,
      unique_result,
      in_classes__,
      matcher);
...
struct FindMethod FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<int32_t> *in_methods() const {
    return GetPointer<const ::flatbuffers::Vector<int32_t> *>(VT_IN_METHODS);
  }
  const schema::MethodMatcher *matcher() const {
    return GetPointer<const schema::MethodMatcher *>(VT_MATCHER);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint8_t>(verifier, VT_UNIQUE_RESULT, 1) &&
...
struct FindMethodBuilder {
  ...
  void add_in_methods(::flatbuffers::Offset<::flatbuffers::Vector<int32_t>> in_methods) {
    fbb_.AddOffset(FindMethod::VT_IN_METHODS, in_methods);
  }
  void add_matcher(::flatbuffers::Offset<schema::MethodMatcher> matcher) {
...
inline ::flatbuffers::Offset<FindMethod> CreateFindMethod(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    bool unique_result = false,
    ::flatbuffers::Offset<::flatbuffers::Vector<int32_t>> in_methods = 0,
    ::flatbuffers::Offset<schema::MethodMatcher> matcher = 0) {
...
inline ::flatbuffers::Offset<FindMethod> CreateFindMethodDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    bool unique_result = false,
    const std::vector<int32_t> *in_methods = nullptr,
    ::flatbuffers::Offset<schema::MethodMatcher> matcher = 0) {
  auto in_methods__ = in_methods ? _fbb.CreateVector<int32_t>(*in_methods) : 0;
  return schema::CreateFindMethod(
      _fbb,
      unique_result,
      in_methods__,
      matcher);
...
struct FindField FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const ::flatbuffers::Vector<int32_t> *in_fields() const {
    return GetPointer<const ::flatbuffers::Vector<int32_t> *>(VT_IN_FIELDS);
  }
  const schema::FieldMatcher *matcher() const {
    return GetPointer<const schema::FieldMatcher *>(VT_MATCHER);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           VerifyField<uint8_t>(verifier, VT_UNIQUE_RESULT, 1) &&
...
struct FindFieldBuilder {
  ...
  void add_in_fields(::flatbuffers::Offset<::flatbuffers::Vector<int32_t>> in_fields) {
    fbb_.AddOffset(FindField::VT_IN_FIELDS, in_fields);
  }
  void add_matcher(::flatbuffers::Offset<schema::FieldMatcher> matcher) {
...
inline ::flatbuffers::Offset<FindField> CreateFindField(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    bool unique_result = false,
    ::flatbuffers::Offset<::flatbuffers::Vector<int32_t>> in_fields = 0,
    ::flatbuffers::Offset<schema::FieldMatcher> matcher = 0) {
...
inline ::flatbuffers::Offset<FindField> CreateFindFieldDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    bool unique_result = false,
    const std::vector<int32_t> *in_fields = nullptr,
    ::flatbuffers::Offset<schema::FieldMatcher> matcher = 0) {
  auto in_fields__ = in_fields ? _fbb.CreateVector<int32_t>(*in_fields) : 0;
  return schema::CreateFindField(
      _fbb,
      unique_result,
      in_fields__,
      matcher);
...
struct BatchFindClassUsingStrings FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  const schema::StringMatcher *find_package_name() const {
    return GetPointer<const schema::StringMatcher *>(VT_FIND_PACKAGE_NAME);
  }
  const ::flatbuffers::Vector<::flatbuffers::Offset<schema::BatchUsingStringsMatcher>> *matchers() const {
    return GetPointer<const ::flatbuffers::Vector<::flatbuffers::Offset<schema::BatchUsingStringsMatcher>> *>(VT_MATCHERS);
  }
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
...
struct BatchFindClassUsingStringsBuilder {
  ...
  ::flatbuffers::FlatBufferBuilder &fbb_;
  ::flatbuffers::uoffset_t start_;
  void add_find_package_name(::flatbuffers::Offset<schema::StringMatcher> find_package_name) {
    fbb_.AddOffset(BatchFindClassUsingStrings::VT_FIND_PACKAGE_NAME, find_package_name);
  }
  void add_matchers(::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<schema::BatchUsingStringsMatcher>>> matchers) {
...
inline ::flatbuffers::Offset<BatchFindClassUsingStrings> CreateBatchFindClassUsingStrings(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<schema::StringMatcher> find_package_name = 0,
    ::flatbuffers::Offset<::flatbuffers::Vector<::flatbuffers::Offset<schema::BatchUsingStringsMatcher>>> matchers = 0) {
...
inline ::flatbuffers::Offset<BatchFindClassUsingStrings> CreateBatchFindClassUsingStringsDirect(
    ::flatbuffers::FlatBufferBuilder &_fbb,
    ::flatbuffers::Offset<schema::StringMatcher> find_package_name = 0,
    const std::vector<::flatbuffers::Offset<schema::BatchUsingStringsMatcher>> *matchers = nullptr) {
  auto matchers__ = matchers ? _fbb.CreateVector<::flatbuffers::Offset<schema::BatchUsingStringsMatcher>>(*matchers) : 0;
  return schema::CreateBatchFindClassUsingStrings(
      _fbb,
      find_package_name,
      matchers__);
}
...
inline ::flatbuffers::Offset<BatchFindMethodUsingStrings> CreateBatchFindMethodUsingStringsDirect(
    ...
    const std::vector<::flatbuffers::Offset<schema::BatchUsingStringsMatcher>> *matchers = nullptr) {
  auto matchers__ = matchers ? _fbb.CreateVector<::flatbuffers::Offset<schema::BatchUsingStringsMatcher>>(*matchers) : 0;
  return schema::CreateBatchFindMethodUsingStrings(
      _fbb,
      find_package_name,
      matchers__);
}
...
#endif  // FLATBUFFERS_GENERATED_QUERYS_SCHEMA_H_
