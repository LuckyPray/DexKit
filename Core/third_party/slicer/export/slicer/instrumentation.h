...
//
//    ...
//    export::MethodInstrumenter mi(dex_ir);
//    mi.AddTransformation<export::EntryHook>(ir::MethodId("LTracer;", "OnEntry"));
//    mi.AddTransformation<export::ExitHook>(ir::MethodId("LTracer;", "OnExit"));
