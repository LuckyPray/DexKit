...
int main() {
    ...
    auto res = dexKit->BatchFindClassesUsingStrings(obfuscate_class, dexkit::mSimilarRegex);
    ...
    auto res_m = dexKit->BatchFindMethodsUsingStrings(obfuscate_method, dexkit::mSimilarRegex);
