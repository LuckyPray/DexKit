...
class ClassMatcher : BaseMatcher, IAnnotationEncodeValue {
    ...
    /**
     * Android Java reflection class modifiers, including hidden Java flag bits.
     ...
     * ----------------
     * Android Java 反射类修饰符，保留隐藏 Java 标志位。
     ...
     *
     * @param modifiers Java reflection modifier mask / Java 反射修饰符掩码
