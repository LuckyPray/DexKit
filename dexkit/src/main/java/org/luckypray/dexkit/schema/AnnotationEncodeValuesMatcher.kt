...
@Suppress("unused")
internal class `-AnnotationEncodeValuesMatcher` : Table() {

    fun __init(_i: Int, _bb: ByteBuffer)  {
        __reset(_i, _bb)
    }
    fun __assign(_i: Int, _bb: ByteBuffer) : `-AnnotationEncodeValuesMatcher` {
        __init(_i, _bb)
        return this
    }
    ...
    companion object {
        ...
        fun getRootAsAnnotationEncodeValuesMatcher(_bb: ByteBuffer): `-AnnotationEncodeValuesMatcher` = getRootAsAnnotationEncodeValuesMatcher(_bb, `-AnnotationEncodeValuesMatcher`())
        fun getRootAsAnnotationEncodeValuesMatcher(_bb: ByteBuffer, obj: `-AnnotationEncodeValuesMatcher`): `-AnnotationEncodeValuesMatcher` {
            _bb.order(ByteOrder.LITTLE_ENDIAN)
            return (obj.__assign(_bb.getInt(_bb.position()) + _bb.position(), _bb))
        }
        fun createAnnotationEncodeValuesMatcher(builder: FlatBufferBuilder, valuesTypeOffset: Int, valuesOffset: Int, matchType: Byte, valueCountOffset: Int) : Int {
            ...
            return endAnnotationEncodeValuesMatcher(builder)
        }
        fun startAnnotationEncodeValuesMatcher(builder: FlatBufferBuilder) = builder.startTable(4)
        ...
        fun endAnnotationEncodeValuesMatcher(builder: FlatBufferBuilder) : Int {
