...
class FieldMeta : Table() {
    ...
    fun mutateType(type: Int) : Boolean {
        val o = __offset(14)
        return if (o != 0) {
            bb.putInt(o + bb_pos, type)
            true
        } else {
            false
        }
    ...
    companion object {
        ...
        fun createFieldMeta(builder: FlatBufferBuilder, id: Int, dexId: Int, annotationsOffset: Int, accessFlags: UInt, dexDescriptorOffset: Int, type: Int) : Int {
        ...
        fun addType(builder: FlatBufferBuilder, type: Int) = builder.addInt(5, type, 0)
