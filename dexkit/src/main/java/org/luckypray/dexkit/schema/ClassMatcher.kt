...
internal class `-ClassMatcher` : Table() {
    ...
    companion object {
        ...
        fun createClassMatcher(builder: FlatBufferBuilder, smaliSourceOffset: Int, classNameOffset: Int, modifiersOffset: Int, accessFlagsOffset: Int, superClassOffset: Int, interfacesOffset: Int, annotationsOffset: Int, fieldsOffset: Int, methodsOffset: Int, usingStringsOffset: Int, allOfOffset: Int, anyOfOffset: Int, noneOfOffset: Int) : Int {
        ...
        fun startClassMatcher(builder: FlatBufferBuilder) = builder.startTable(13)
        ...
        fun addModifiers(builder: FlatBufferBuilder, modifiers: Int) = builder.addOffset(2, modifiers, 0)
        ...
        fun addAllOf(builder: FlatBufferBuilder, allOf: Int) = builder.addOffset(10, allOf, 0)
        ...
        fun addAnyOf(builder: FlatBufferBuilder, anyOf: Int) = builder.addOffset(11, anyOf, 0)
        ...
        fun addNoneOf(builder: FlatBufferBuilder, noneOf: Int) = builder.addOffset(12, noneOf, 0)
